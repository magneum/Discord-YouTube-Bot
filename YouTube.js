...
// ============================================================================================================================
try {
  ʜʏᴘᴇʏᴏᴜᴛᴜʙᴇ.on(`guildCreate`, (guild) => {
...
𝗗𝗲𝗮𝗿: @everyone
=========⚜️=========
ᴀ channel ɴᴀᴍᴇ **yt🔺downloader** inside **🔱Krakinz** has been successfully created.
Please use the channel for any **𝗬𝗼𝘂𝗧𝘂𝗯𝗲🔺** commands..`
          )
      )
      .catch(console.error);
    // =============================================================================================================================
...
ʜʏᴘᴇʏᴏᴜᴛᴜʙᴇ.on(`message`, async (message) => {
  ...
  if (
    ...
    message.channel.name !== `yt🔺downloader`
  ) {
    if (
      message.guild.channels.cache.find(
        (channel) => channel.name === `yt🔺downloader`
      )
    ) {
      const embedfactor = new Discord.MessageEmbed()
        .setColor("#B33F40")
        .setTitle(`𝗬𝗼𝘂𝗧𝘂𝗯𝗲🔺𝐛𝐲🔱𝐊𝐫𝐚𝐤𝐢𝐧𝐳`)
        .setAuthor(`🔱𝐊𝐫𝐚𝐤𝐢𝐧𝐳`)
        .setDescription(
          `
**⚠️WARNING⚠️** 
...
=𝘌𝘮𝘣𝘦𝘥𝘴`
  ...
  // ===========================================•YouTube🔺Downloader ©️•==================================================
  if (
    !message.content.startsWith(ʙᴏᴛꜰɪx + `yt https://www.youtube`) &&
    message.channel.name === `yt🔺downloader`
  ) {
