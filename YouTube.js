...
// ===========================================•YouTube⭕️Downloader ©️•==================================================
if (ʙᴏᴛꜰɪx === undefined) {
    console.log(`----> •YouTube⭕️Downloader ©️• <----\n\nPrefix is undefined`);
    return;
}
...
ʜʏᴘᴇʏᴏᴜᴛᴜʙᴇ.on(`ready`, () => {
    console.clear();
    ʜʏᴘᴇʏᴏᴜᴛᴜʙᴇ.user.setActivity(`⭕️ ${ʙᴏᴛꜰɪx}yt `, { type: `WATCHING` });
    console.log(`
•YouTube⭕️Downloader ©️• |>••••••••••••••••••••••••••
|
...
•|  🎃**VERY VERY IMPORTANT**🎃_Please use !calib once to calibrate before first use!_`
            ...
            .setFooter(`⭕️-----------|     ©️YouTube⭕️Downloader`,
...
•|  _Please use the channel for any ʏᴏᴜᴛᴜʙᴇ download._`)
                ...
                console.log(`•YouTube⭕️Downloader ©️• has been successfully created.`);
            } else {
...
=𝘌𝘮𝘣𝘦𝘥𝘴`)
                ...
                message.channel
                    .send(embedcheck2)
                    .catch(console.error);
                console.log(`•YouTube⭕️Downloader ©️• could not be created.`);
                return;
            }
        }
        // ===========================================•YouTube⭕️Downloader ©️•==================================================
            ...
            try {
                ...
                try {
                    const embed4 = new Discord.MessageEmbed()
                        .setColor(10038562)
                        .setTitle(`----> •YouTube⭕️Downloader ©️• <----`)
                        .setAuthor(`⚜️HypeVoidSoul`)
                        .setDescription(`
---------------------|⭕️|---------------------
**⚠️WARNING⚠️** 
...
**${ᴀʀɢꜱ.join(` `)}**`
                        ...
                        .setImage(`https://i.postimg.cc/cJYg7gnT/teahub-io-2048x1152-wallpaper-for-youtube-307808.png`)
                        .setThumbnail(`https://i.postimg.cc/cJYg7gnT/teahub-io-2048x1152-wallpaper-for-youtube-307808.png`)
                        .setFooter(`----> •YouTube⭕️Downloader ©️• <----`,
                            `https://i.postimg.cc/cJYg7gnT/teahub-io-2048x1152-wallpaper-for-youtube-307808.png`);
                    message.channel
                        .send(embed4)
                        .then((message) => {
...
•|  _Please ᴡᴀit ᴛɪʟʟ •YouTube⭕️Downloader ©️• finishes downloading..._`
                    )
                    .setImage(`https://i.postimg.cc/cJYg7gnT/teahub-io-2048x1152-wallpaper-for-youtube-307808.png`)
                    .setThumbnail(`https://i.postimg.cc/cJYg7gnT/teahub-io-2048x1152-wallpaper-for-youtube-307808.png`)
                    .setFooter(`----> •YouTube⭕️Downloader ©️• <----`, `https://i.postimg.cc/cJYg7gnT/teahub-io-2048x1152-wallpaper-for-youtube-307808.png`);
                message.channel
                    .send(embed5)
                    .then((message) => {
